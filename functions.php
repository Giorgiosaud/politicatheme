...
require_once('custom-posts/events.php');
require_once('custom-posts/profesores.php');
...
/*------------------------------------*\
  ...
  if (function_exists('add_theme_support'))
  {
    ...
    add_image_size('slider-incio', 850, 400, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('noticia', 250, 150, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('evento', 250, 150, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-
